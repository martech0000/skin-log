...
$('#messages').addEventListener('click', event => {
  ...
  if (menu) { menu.parentElement.classList.toggle('open'); return; }
  const cancel = event.target.closest('.cancel-message');
  if (cancel) cancelMessage(cancel.dataset.id);
});
